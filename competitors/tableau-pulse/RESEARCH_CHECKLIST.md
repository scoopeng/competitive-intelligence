# Tableau Pulse Research Checklist - Complete Protocol
...
- [X] Checked `../../archive/` for any Tableau Pulse related files
- [X] Checked `../../evidence/` for existing Tableau Pulse content
- [X] Listed all existing files in `competitors/tableau-pulse/` directory
...
- [X] research/ folder exists with 9 files
- [X] evidence/ folder exists with 5 files
- [X] outputs/ folder exists with 0 files
- [X] Archive contained: tableau-pulse-vs-scoop.md with BUPAF scoring
```
...
- [ ] **Case Study Comparisons** - "Customer X tried Tableau Pulse, switched to Scoop because..."
